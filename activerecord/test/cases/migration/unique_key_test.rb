      ...
      class UniqueKeyTest < ActiveRecord::TestCase
        ...
        def test_unique_keys
          ...
          expected_constraints = [
            {
              name: "test_unique_keys_position_deferrable_true",
              deferrable: true,
              columns: ["position_1"]
            }, {
        ...
        def test_add_unique_key_with_deferrable_true
          ...
          assert_equal "sections", constraint.table_name
          assert_equal "uniq_rails_3d89d7e853", constraint.name
          assert_equal true, constraint.deferrable
        end

        def test_added_unique_key_deferrable
          @connection.add_unique_key :sections, [:position], deferrable: true, name: "unique_section_position"
