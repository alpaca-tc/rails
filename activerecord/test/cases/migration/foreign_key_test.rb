    ...
    class Migration
      class ForeignKeyTest < ActiveRecord::TestCase
        ...
        if ActiveRecord::Base.connection.supports_deferrable_constraints?
          ...
          def test_deferrable_foreign_key_when_raise_on_foreign_key_deferrable_true_is_true
            original = ActiveRecord.raise_on_foreign_key_deferrable_true
            ActiveRecord.raise_on_foreign_key_deferrable_true = false
            ...
            expected = assert_deprecated(ActiveRecord.deprecator) do
              fk.deferrable
            end

            assert_equal true, expected
          ensure
            ActiveRecord.raise_on_foreign_key_deferrable_true = original
          end
