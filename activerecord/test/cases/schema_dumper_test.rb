...
class SchemaDumperTest < ActiveRecord::TestCase
  ...
  if ActiveRecord::Base.connection.supports_unique_keys?
    def test_schema_dumps_unique_keys
      ...
      assert_match 't.unique_key ["position_1"], deferrable: true, name: "test_unique_keys_position_deferrable_true"', output
      assert_match 't.unique_key ["position_2"], deferrable: true, name: "test_unique_keys_position_deferrable_immediate"', output
