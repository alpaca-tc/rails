  ...
  module ConnectionAdapters
    module PostgreSQL
      module SchemaStatements
        ...
        # [<tt>:deferrable</tt>]
        #   Specify whether or not the unique constraint should be deferrable. Valid values are booleans or +:deferred+ or +:immediate+ to specify the default behavior. Defaults to +false+.
        ...
        private
          ...
          def unique_key_for(table_name, **options)
            constraint_name = unique_key_name(table_name, **options)
            unique_keys(table_name).detect { |constraint| constraint.name == constraint_name }
          end
